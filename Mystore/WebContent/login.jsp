...
<div class="header">
    <div class="h_center">
        ...
        <p>为确保您账户的安全及正常使用，依《网络安全法》相关要求，4月1日起会员账户需绑定手机。如您还未绑定，请尽快完成，感谢您的理解及支持！</p>
    </div>
</div>
...
<div class="login_body">
    ...
    <div class="login_center">
        ...
        <div class="login_bg">
            <h4>忘记密码</h4>
            <form action="/Mystore/LoginServlet"  id="login" method="post">
                <!--用户名-->
               <div class="username">
               		<span></span>
            ...
            <div class="forgotPwd"><!--忘记密码-->
                <a href="#">忘记密码</a> <a href="#">忘记会员名</a> <a href="/Mystore/regist.jsp">免费注册</a>
            </div>
        </div>
    </div>
</div>
