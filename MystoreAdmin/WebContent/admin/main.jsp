...
<body style="background: #f3f3f3;">
	...
	<div class="goods_list">
		...
		<c:forEach items="${pageBean.goodsList }" var="goods"
			varStatus="status">
			...
			<ul class="list_goods_ul">
				...
				<li>${goods.price }</li>
				<li><a
					href="${ctx }/GoodsServlet?action=editUI&id=${goods.id}&currentPage=${pageBean.currentPage}"><img
						class="img_icon" src="${ctx }/admin/images/edit_icon.png"></a></li>
				<li><a
					href="${ctx }/GoodsServlet?action=delGoods&id=${goods.id}&currentPage=${pageBean.currentPage}"><img
						class="img_icon" src="${ctx }/admin/images/delete_icon.png"></a></li>
			</ul>
		</c:forEach>

		<!--分页-->
		<div id="page" class="page_div">没有商品数据</div>
	</div>
	...
	<script>
	    ...
	    $("#input_search_btn").click(function () {
	        $(window).attr('location',"${ctx}/GoodsServlet?action=search");
	    });
